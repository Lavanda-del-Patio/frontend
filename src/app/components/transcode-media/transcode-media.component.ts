...
@Component({
    selector: 'app-transcode-media',
    templateUrl: './transcode-media.component.html',
    styleUrls: ['./transcode-media.component.scss']
})
export class TranscodeMediaComponent implements OnInit, OnDestroy {
